...
//     // TORCH
    ...
    lv_obj_align(torch_btn, LV_ALIGN_LEFT_MID, 0, 0);  // Aggiungere margine per evitare che i pulsanti si tocchino
    ...
    lv_obj_set_style_text_color(bhs_label, lv_color_hex(0x000000), 0);  // Black text color
...
//     // HOME
    ...
    lv_obj_align(home_BTN_label, LV_ALIGN_RIGHT_MID, 0, 0);
